        ...
        <div>
            ...
            <section className="skill-section section py-5">
                <div className="container">
                    ...
                    <div className="section-intro mx-auto mb-5 text-secondary" style= {{textAlign: 'justify',textJustify: 'inter-word'}}>Working as a Freelancer and Web Development Intern at Bombay Blokes, 
